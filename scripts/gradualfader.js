...
gradualFader.baseopacity=0.9 //set base opacity when mouse isn't over element (decimal below 1)
gradualFader.increment=0.5 //amount of opacity to increase after each iteration (suggestion: 0.1 or 0.2)
